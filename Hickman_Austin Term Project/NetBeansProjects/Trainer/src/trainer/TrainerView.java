 ...
 */
public class TrainerView extends FrameView {
    
    public TrainerView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        trainer.Trainer t = new trainer.Trainer();
    ...
    public void deleteRecord() {
        ...
        List<trainer.Trainer> toRemove = new ArrayList<trainer.Trainer>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            trainer.Trainer t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<trainer.Trainer> merged = new ArrayList<trainer.Trainer>(list.size());
                for (trainer.Trainer t : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = TrainerApp.getApplication().getMainFrame();
            aboutBox = new TrainerAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        TrainerApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(trainer.TrainerApp.class).getContext().getResourceMap(TrainerView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(trainer.TrainerApp.class).getContext().getActionMap(TrainerView.class, this);
    ...
    private java.util.List<trainer.Trainer> list;
