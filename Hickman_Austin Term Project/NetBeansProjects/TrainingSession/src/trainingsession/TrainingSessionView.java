 ...
 */
public class TrainingSessionView extends FrameView {
    
    public TrainingSessionView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        trainingsession.Client c = new trainingsession.Client();
    ...
    public void deleteRecord() {
        ...
        List<trainingsession.Client> toRemove = new ArrayList<trainingsession.Client>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            trainingsession.Client c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<trainingsession.Client> merged = new ArrayList<trainingsession.Client>(list.size());
                for (trainingsession.Client c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = TrainingSessionApp.getApplication().getMainFrame();
            aboutBox = new TrainingSessionAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        TrainingSessionApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        clientMembershipTypeLabel = new javax.swing.JLabel();
        clientJoinDateLabel = new javax.swing.JLabel();
        membershipExpirationDateLabel = new javax.swing.JLabel();
        ...
        clientMembershipTypeField = new javax.swing.JTextField();
        clientJoinDateField = new javax.swing.JTextField();
        membershipExpirationDateField = new javax.swing.JTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(trainingsession.TrainingSessionApp.class).getContext().getResourceMap(TrainingSessionView.class);
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${clientMembershipType}"));
        columnBinding.setColumnName("Client Membership Type");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${clientJoinDate}"));
        columnBinding.setColumnName("Client Join Date");
        columnBinding.setColumnClass(java.util.Date.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${membershipExpirationDate}"));
        columnBinding.setColumnName("Membership Expiration Date");
        columnBinding.setColumnClass(java.util.Date.class);
        ...
        clientMembershipTypeLabel.setText(resourceMap.getString("clientMembershipTypeLabel.text")); // NOI18N
        clientMembershipTypeLabel.setName("clientMembershipTypeLabel"); // NOI18N

        clientJoinDateLabel.setText(resourceMap.getString("clientJoinDateLabel.text")); // NOI18N
        clientJoinDateLabel.setName("clientJoinDateLabel"); // NOI18N

        membershipExpirationDateLabel.setText(resourceMap.getString("membershipExpirationDateLabel.text")); // NOI18N
        membershipExpirationDateLabel.setName("membershipExpirationDateLabel"); // NOI18N
        ...
        clientMembershipTypeField.setName("clientMembershipTypeField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.clientMembershipType}"), clientMembershipTypeField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), clientMembershipTypeField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        clientJoinDateField.setName("clientJoinDateField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.clientJoinDate}"), clientJoinDateField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), clientJoinDateField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        membershipExpirationDateField.setName("membershipExpirationDateField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.membershipExpirationDate}"), membershipExpirationDateField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), membershipExpirationDateField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(trainingsession.TrainingSessionApp.class).getContext().getActionMap(TrainingSessionView.class, this);
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(clientMembershipTypeLabel)
                            .addComponent(clientJoinDateLabel)
                            .addComponent(membershipExpirationDateLabel))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(clientNumberField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                            .addComponent(clientLastNameField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                            .addComponent(clientFirstNameField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                            .addComponent(clientPhoneField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                            .addComponent(clientEmailField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                            .addComponent(clientMembershipTypeField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                            .addComponent(clientJoinDateField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                            .addComponent(membershipExpirationDateField, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)))
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(clientMembershipTypeLabel)
                    .addComponent(clientMembershipTypeField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(clientJoinDateLabel)
                    .addComponent(clientJoinDateField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(membershipExpirationDateLabel)
                    .addComponent(membershipExpirationDateField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saveButton)
                    .addComponent(refreshButton)
    ...
    private javax.swing.JTextField clientJoinDateField;
    private javax.swing.JLabel clientJoinDateLabel;
    private javax.swing.JTextField clientLastNameField;
    private javax.swing.JLabel clientLastNameLabel;
    private javax.swing.JTextField clientMembershipTypeField;
    private javax.swing.JLabel clientMembershipTypeLabel;
    ...
    private java.util.List<trainingsession.Client> list;
    private javax.swing.JPanel mainPanel;
    private javax.swing.JScrollPane masterScrollPane;
    private javax.swing.JTable masterTable;
    private javax.swing.JTextField membershipExpirationDateField;
    private javax.swing.JLabel membershipExpirationDateLabel;
