...
public class DesktopApplication1View extends FrameView {
    ...
    public void newRecord() {
        desktopapplication1.Trainer t = new desktopapplication1.Trainer();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication1.Trainer> toRemove = new ArrayList<desktopapplication1.Trainer>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication1.Trainer t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication1.Trainer> merged = new ArrayList<desktopapplication1.Trainer>(list.size());
                for (desktopapplication1.Trainer t : list) {
    ...
    private java.util.List<desktopapplication1.Trainer> list;
